...
* [`src/medals/`](src/medals/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/medals/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `medals` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/medals/config.cljs) defaults to `true` in
...
```clj
(ns medals.example
  (:require [medals.config :as config])
